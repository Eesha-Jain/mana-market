    ...
    <div className="page">
      <div className="page-header">
        ...
        <div className="page-actions">
          <Link to="/upload" className="btn-primary">+ Add Items</Link>
          {items.length > 0 && (
            <Link to="/review" className="btn-secondary">Review & Price →</Link>
          )}
        </div>
      </div>
      ...
      {items.length === 0 ? (
        <div className="empty-dashboard">
          ...
          <Link to="/upload" className="btn-primary">Upload Items</Link>
        </div>
      ) : (
        <div className="dashboard-table-section">
          <div className="section-header">
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              <Link to="/review" className="btn-secondary btn-sm">Edit & Price</Link>
